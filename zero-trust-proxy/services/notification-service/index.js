...
const FAKE_NOTIFICATIONS = [
  { id: "notif_001", userId: 1, channel: "email", subject: "Payment confirmed", sentAt: "2026-07-30T09:12:00Z" },
  { id: "notif_002", userId: 2, channel: "sms", subject: "Payment pending", sentAt: "2026-07-30T09:15:00Z" },
  { id: "notif_003", userId: 1, channel: "push", subject: "New login detected", sentAt: "2026-07-31T22:05:00Z" },
];
...
app.get("/data", (req, res) => {
  ...
  res.json({ service: SERVICE_NAME, records: FAKE_NOTIFICATIONS });
});
