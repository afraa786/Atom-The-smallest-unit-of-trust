    ...
    <>
      <section id="cta" className="relative bg-black py-28">
        ...
        <motion.div
          ...
          className="relative mx-auto max-w-3xl px-3 text-center sm:px-0"
        >
      ...
      <footer className="border-t border-white/10 bg-black py-10">
        <div className="mx-auto flex max-w-7xl flex-col items-center gap-4 px-3 text-center sm:flex-row sm:justify-between sm:px-0 sm:text-left">
